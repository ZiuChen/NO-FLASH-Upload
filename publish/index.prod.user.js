...
async function(){return await hf(bf,(e=>e.querySelectorAll(".userinfobody>ul>li"))).then((e=>{let t={name:"",loginTime:"",onlineTime:"",loginTimes:""};return e.forEach(((e,o)=>{t[Object.keys(t)[o]]=e.innerText.split("：")[1].trim()})),t})).catch((e=>{console.log(e)}))},getRemindInfo:async function(){return await hf(gf,(e=>e.querySelectorAll("ul[id='reminder']>li>ul"))).then((e=>{let t={notify:[],hwt:[]};
// return obj;
// FIXME: Debugging
return e.forEach(((e,o)=>{e.querySelectorAll("li>a").forEach((e=>{let o={name:"",id:"",type:""};o.name=e.innerText.trim(),o.id=e.getAttribute("href").split("lid=")[1].split("&t=")[0],o.type=e.getAttribute("href").split("lid=")[1].split("&t=")[1],"hw"===o.type?t.hwt.push(o):"info"===o.type&&t.notify.push(o)}))})),{notify:[{name:"电子测量",id:"19003",type:"info"},{name:"传感器与检测技术",id:"20697",type:"info"},{name:"现代控制理论",id:"10625",type:"info"}],hwt:[{name:"现代控制理论",id:"10625",type:"info"},{name:"计算机控制系统",id:"16597",type:"info"}]}})).catch((e=>{console.log(e)}))},getLessonInfo:async function(){return await hf(vf,(e=>e.querySelectorAll("tbody>tr"))).then((e=>{let t=[];return e.forEach(((e,o)=>{if(0===o)return;let l={id:"",name:"",academy:"",teacher:""},n=e.firstElementChild.firstElementChild,r=e.children[1],a=e.children[2];l.id=n.getAttribute("href").split("lid=")[1],l.name=n.innerText.split("\n")[0].trim(),l.academy=r.innerText.split("\n")[0],l.teacher=a.innerText.split("\n")[0],t.push(l)})),t})).catch((e=>{console.log(e)}))},getHwtInfo:async function(e){return await hf(yf,(e=>e.querySelectorAll("tbody>tr"))).then((t=>{
// TODO: add hadSubmit
...
async function(){return Dm(`current userscript version: ${Rm.version}`),hf(Rm.githubJsonUrl,(e=>JSON.parse(e.querySelector("body").innerText).version)).then((e=>{let t=0,o=0;return e.split(".").reverse().forEach(((e,o)=>{t+=(o+1)*Math.pow(10,o+1)*parseInt(e)})),Rm.version.split(".").reverse().forEach(((e,t)=>{o+=(t+1)*Math.pow(10,t+1)*parseInt(e)})),t>o?{need:!0,current:Rm.version,lastest:e}:{need:!1,current:Rm.version,lastest:e}}))};
